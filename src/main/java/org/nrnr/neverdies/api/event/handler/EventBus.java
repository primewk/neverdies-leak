 ...
 * @see Event
 * @see EventHandler
 * @see org.nrnr.neverdies.api.event.listener.EventListener
 * @see Listener
 * @since 1.0
 */
public class EventBus implements EventHandler {
     ...
     * {@link org.nrnr.neverdies.api.event.listener.EventListener} in the class to the active listener map.
     *
