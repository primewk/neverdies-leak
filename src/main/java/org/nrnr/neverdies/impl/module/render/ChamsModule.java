...
import org.nrnr.neverdies.impl.event.render.entity.RenderCrystalEvent;
import org.nrnr.neverdies.impl.event.render.entity.RenderEntityEvent;
...
public class ChamsModule extends ToggleModule {
    ...
    Config<Boolean> monstersConfig = new BooleanConfig("Monsters", "Render chams on monsters", false);
    Config<Boolean> animalsConfig = new BooleanConfig("Animals", "Render chams on animals", false);
